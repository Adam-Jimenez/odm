...
public class DaoTest {
	...
	/**
	 * This test shows inserting an object directly in a document 
	 * fails
	 * @throws DbNotFound
	 */
	@Test
	...
	public void test() throws DbNotFound {
		...
		/* 
		The reason why we do two insertOnes is because the second insert fails
		therefore we couldn't see the first one working
		*/
		...
		// We need a better way to insert Objects in a noSQL database (see next test)
	}


	/**
	 * This test shows that using reflection can solve the problem
	 * @throws Exception
	 */
	@Test
